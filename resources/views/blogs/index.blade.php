    ...
    <div class="container-fluid">
        ...
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">News / Berita</a></li>
            </ol>
        </div>
        <!-- row -->
                                ...
                                <tbody>
                                    @foreach ($blogs as $blog)
                                        <tr data-identifier="{{ $blog->id }}">
                                            ...
                                            <td><img src="{{ Storage::disk('public')->url($blog->thumbnail) }}" alt=""
