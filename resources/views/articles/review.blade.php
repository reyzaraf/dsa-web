...
@section('content')
    ...
    <div class="btn-group d-flex justify-content-center">
        <form action="{{ route('admin.articles.accepting', $article->id) }}" method="POST"
        ...
        <form class="pl-2" action="{{ route('admin.articles.declining', $article->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('POST')
            ...
            <div class="container">
                <div class="page-title__holder">
                    ...
                    <ul class="entry__meta">
                        <li class="entry__meta-date">{{ $article->created_at->format('d F Y') }}</li>
                    </ul>
                </div>
            </div>
        </section>
                            ...
                            <article class="entry mb-0">
                                <div class="entry__article-wrap">
                                    <div class="entry__article">
                                            <center class="pb-5">
                                            <img width="500px" height="100%" src="{{ Storage::disk('public')->url($article->thumbnail) }}" alt="">
                                            </center>
                                        {!! $article->body !!}
                                    </div>
                                    <!-- end entry article -->
